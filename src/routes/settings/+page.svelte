...
<main>
	...
	<section>
		...
		{#if data.user.registeredTOTP}
			<a href="/auth/2fa/totp/setup">Update TOTP</a>
			<form method="post" use:enhance action="?/disconnect_totp">
				<button>Disconnect</button>
			</form>
		{:else}
			<a href="/auth/2fa/totp/setup">Set up TOTP</a>
		{/if}
	</section>
	<section>
		<h2>Passkeys</h2>
		...
		<a href="/auth/2fa/passkey/register">Add</a>
	</section>
	<section>
		<h2>Security keys</h2>
		...
		<a href="/auth/2fa/security-key/register">Add</a>
	</section>
